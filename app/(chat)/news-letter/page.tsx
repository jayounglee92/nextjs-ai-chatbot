    ...
    <div className="flex flex-1 flex-col  p-8">
      <div className="space-y-4  flex flex-col">
        <div className="flex items-center gap-2">
          <h1 className="text-2xl font-semibold text-foreground">뉴스레터</h1>
        </div>
        <p className="text-muted-foreground">뉴스레터 목록입니다.</p>
      </div>
      <div className="flex-1">
        <div className="mb-6">
          <h2 className="text-lg font-medium mb-4">뉴스레터 목록</h2>
