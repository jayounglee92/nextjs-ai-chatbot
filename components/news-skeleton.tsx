    ...
    <div className="grid grid-cols-12 gap-4">
      ...
      <article className="md:py-4 border rounded-lg md:rounded-none md:border-x-0 overflow-hidden bg-white col-span-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
          ...
          {/* 이미지 스켈레톤 */}
          <div className="relative overflow-hidden h-64 md:h-80 rounded-lg order-1 md:order-2">
          ...
          return (
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                ...
                {/* 이미지 스켈레톤 */}
                <div
                  className={`relative overflow-hidden h-64 md:h-80 rounded-lg ${
